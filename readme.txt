...
* Improving sale and discount price display

= 0.7.3 =
* Fixing a bug that prevented before/after sale prices from displaying correctly
...
= 0.6.6 =
* Making the use of "default SKUs" if a product SKU is not set optional

= 0.6.5.1 =
* Fixing Icelandic language strings

= 0.6.5 =
* Splitting the monolithic cron job into multiple smaller ones
* Optionally deferring invoice generation to a cron job

= 0.6.4.2 =
* Further improvements to caching strategy
* Further improvements to invoice generation and subtotal/total rounding
...
= 0.6.3 =
* Improving discount display for logged-in customers
