...
class Product {
	 ...
	 * @param bool                $incl_tax Wether or not to display the prices inclusive of tax.
	 * @param false|array         $prices The pricess array as generated by `get_variation_prices`.
	 *
	 ...
	 * @param bool                $incl_tax Wether or not to include taxes in the prices.
	 */
