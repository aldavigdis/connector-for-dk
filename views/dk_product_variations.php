		...
		<?php foreach ( $wc_variable_product->get_children() as $variation_id ) : ?>
			...
			>
				...
				<div class="dk-variation-image">
					...
					>
						<img
							src="<?php echo $variation->get_image_id( 'edit' ) ? esc_url( wp_get_attachment_image_url( $variation->get_image_id( 'edit' ), 'connector_for_dk_variant' ) ) : esc_url( wc_placeholder_img_src() ); ?>"
